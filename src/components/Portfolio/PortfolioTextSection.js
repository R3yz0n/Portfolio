...
const PortfolioTextSection = () => {
    return (
        <div className='pb-3 md:pb-6 pt-4'>
            <p className='text-3xl sm:text-4xl md:text-5xl opacity-80 font-bold flex px-1 ' data-aos='fade-down'>
            ...
            <p className='py-6 text-[1.1rem] md:text-[1.4rem] font-josefin-sans' data-aos='fade-right'>Checkout some of my work right here .</p>
        </div>
    )
}
