...
const About = () => {
    ...
    return (
        <div name='about' className="w-full min-h-[80vh] text-white bg-gradient-to-b from-gray-800 to-gray-800 m-auto py-0">
            ...
            <main className='flex flex-col sm:flex-row w-[85%]  h-auto mx-auto'>
                ...
                <section className=' w-[85%] sm:h-auto sm:w-1/3 mx-auto' data-aos='zoom-out-right'>
                    ...
                    <img src={PozzyImg} className='h-full w-full mx-auto' alt="CANDID" />
                </section>

                <section className='w-full mx-auto pb-4 sm:pb-0 md:w-2/3 font-josefin-sans flex flex-col gap-3 sm:shadow-2xl  sm:shadow-gray-500/30
                 md:border-[3px] border-[rgb(39,48,61)] md:border-l-0 overflow-hidden'>

                    <p className='text-3xl text-center underline py-4' data-aos='fade-down' data-aos-duration="1600">Brief about me</p>
                    <p className='font-josefin-sans px-4 text-sm md:text-md lg:text-lg pb-6' data-aos='fade-down' >{desc}</p>
