    ...
    return (
        ...
        <main className='min-h-[90vh] w-full bg-gradient-to-b from-black  to-gray-800 text-white pt-12 md:relative overflow-hidden'>
            ...
            <article className='max-w-[1100px]   mx-auto flex flex-col-reverse md:flex-row h-full items-center' >
                ...
                <section className='flex flex-col justify-center  md:w-[70%] py-12  px-6' data-aos='fade-right' data-aos-duration='1400'>
                    ...
                    <p className='text-gray-500 py-4 max-w-lg sm:text-xl text-[1.17rem]' data-aos='fade-right' data-aos-duration='1200'>{myDescription}</p>
