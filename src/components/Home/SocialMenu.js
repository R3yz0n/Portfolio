...
const SocialMenu = () => {
    return (
        ...
        <div className='flex flex-row top-[20%] left-0 absolute md:hidden' data-aos='fade-right' data-aos-duration='1200'>

            <ul>
                {
                    SocialLinksData.map(({ child, href, style, download, id }) =>

                    (<li key={id} className={`flex justify-between items-center w-[9.1rem] h-14 px-3 sm:h-16 
